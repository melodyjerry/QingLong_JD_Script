  ...
  for (let i = 0; i < newShareCodes.length; i++) {
    ...
    if ($.helpResult.code === '0') {
      if ($.helpResult.helpResult.code === '0') {
        ...
        console.log(`【助力好友结果】: 助力【${$.helpResult.helpResult.masterUserInfo.nickName}】成功`);
        helpSuccessPeoples += ($.helpResult.helpResult.masterUserInfo.nickName || '匿名用户') + ',';
      } else if ($.helpResult.helpResult.code === '8') {
        console.log(`【助力好友结果】: 助力【${$.helpResult.helpResult.masterUserInfo.nickName}】失败，助力次数已耗尽`);
      } else if ($.helpResult.helpResult.code === '9') {
        console.log(`【助力好友结果】: 重复助力【${$.helpResult.helpResult.masterUserInfo.nickName}】`);
      } else if ($.helpResult.helpResult.code === '10') {
        console.log(`【助力好友结果】: 【${$.helpResult.helpResult.masterUserInfo.nickName}】已满助力`);
        //插入头部
      ...
      let res = JSON.stringify($.helpResult);
      console.log(`助力失败::${res}`);
      if (resMsg.indexOf('not login') != -1) {
        break;
      }
    }
  }
