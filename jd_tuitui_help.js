...
!(async () => {
     ...
     await requestAlgo();
     for (let i = 0; i < $.cookieArr.length && i < 3; i++) {
                    ...
                    if (err) {
                         ...
                         if (safeGet(data)) {
                              ...
                              if (data.code === 0){
                                   ...
                                   console.log(`助力信息:${data.msg},code:${data.code}\n`)
                              }
                              resolve(data.code);
                         }
                    }
...
function getAuthorShareCode() {
     return new Promise(resolve => {
          $.get({
               url: "https://raw.githubusercontent.com/inoyna12/updateTeam/master/shareCodes/tyt.json",
               headers: {
