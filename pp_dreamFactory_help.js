...
[task_local]
#京喜工厂内部互助
5 6,18 * * * jd_dreamFactory_help.js, tag=京喜工厂内部互助, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "5 6,18 * * *" script-path=jd_dreamFactory_help.js,tag=京喜工厂内部互助

===============Surge=================
京喜工厂内部互助 = type=cron,cronexp="5 6,18 * * *",wake-system=1,timeout=3600,script-path=jd_dreamFactory_help.js

============小火箭=========
京喜工厂内部互助 = type=cron,script-path=jd_dreamFactory_help.js, cronexpr="5 6,18 * * *", timeout=3600, enable=true
